...
const StatCard = ({ icon, value, label, accent, color, description }: StatItem) => {
    return (
        <motion.div variants={statVariants} className="flex items-center gap-4 p-5 md:p-6 bg-stone-50">
            ...
            <div className="min-w-0">
                ...
                <p className={`text-2xl md:text-3xl font-bold tabular-nums leading-none ${color}`}>{value.toLocaleString()}</p>
